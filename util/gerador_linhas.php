...
function geraFooter () {
	...
	$footer .= sprintf("%s\n"," </td><td align=\"right\">");
	if ($bd==2) 	$footer .= sprintf("%s   ","<img src=\"imagens/ass_dunas_cbm_chrono.png\" width=250 border=0 align=\"absmiddle\"/>");
	elseif ($bd==3) $footer .= sprintf("%s   ","<img src=\"imagens/ass_dunas_fim_chrono.png\" width=250 border=0 align=\"absmiddle\"/>");
	else 			$footer .= sprintf("%s   ","<img src=\"imagens/ass_dunas_cba_chrono.png\" width=250 border=0 align=\"absmiddle\"/>");
	$footer .= sprintf("%s\n","</td></tr></table>");
	$footer .= sprintf("%s\n","</td></tr></table>");
	return $footer;
}
