...
if ($_REQUEST['prova']==2) $col_status = "c03_status2";
else $col_status = "c03_status";

if ($_REQUEST['campeonato']=="P") $col_categoria = "c13_codigo2";
else $col_categoria = "c13_codigo";
...
$str_sql .= ",'.',2) ";
/*$str_sql .= ",'.',substring(substring_index(0";
for ($f=0;$f<count($arr_ss);$f++) {
		if ($arr_ss[$f]<=$ss_max) $str_sql .= "+calcTempo(c03_codigo,".$arr_ss[$f].",c10_codigo,6)-calcPenalidade(c03_codigo,".$arr_ss[$f].", c10_codigo) ";
	}
	//$str_sql .= ") - (";
